(ns food.view.auth
    (:require [ring.util.response :as response]
              ...
              [food.util.session :as session]
              [food.util.flash :as flash]
              [food.view.common :refer [wrap-context-root get-context-root wrap-layout]]
              [food.service.linkedin :as linkedin]))
